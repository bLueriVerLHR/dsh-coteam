...
//
// Deliberately dependency-free: it parses only the flat row metadata the dsh
// agent-presets loader relies on. Every top-level row is written as
...
// this validator — the dsh loader checks their semantics at mount time.
//
...
function validateAgentCordis(text) {
  ...
  const current = { id: null, name: null, group: null }
...
module.exports = { validateAgentCordis }
